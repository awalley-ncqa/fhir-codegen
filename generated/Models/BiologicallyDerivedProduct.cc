...
namespace fhir_R4
{
  ...
  /// </summary>
  struct BiologicallyDerivedProductCollection {
    /// <summary>
  ...
  /// </summary>
  struct BiologicallyDerivedProductProcessing {
    /// <summary>
    /// Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
    /// </summary>
    string _id;
  ...
  /// </summary>
  struct BiologicallyDerivedProductManipulation {
    /// <summary>
    /// Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
    /// </summary>
    string _id;
  ...
  /// Product storage.
  /// </summary>
  struct BiologicallyDerivedProductStorage {
    /// <summary>
    /// Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
    /// </summary>
    string _id;
  ...
  struct BiologicallyDerivedProduct {
    ...
    /// How this product was collected.
    /// </summary>
    BiologicallyDerivedProductCollection* _collection;
    /// <summary>
    /// Any processing of the product during collection that does not change the fundamental nature of the product. For example adding anti-coagulants during the collection of Peripheral Blood Stem Cells.
    /// </summary>
    size_t _processing_count;
    BiologicallyDerivedProductProcessing** _processing;
    /// <summary>
    /// Any manipulation of product post-collection that is intended to alter the product.  For example a buffy-coat enrichment or CD8 reduction of Peripheral Blood Stem Cells to make it more suitable for infusion.
    /// </summary>
    BiologicallyDerivedProductManipulation* _manipulation;
    /// <summary>
    /// Product storage.
    /// </summary>
    size_t _storage_count;
    BiologicallyDerivedProductStorage** _storage;
  };
};
