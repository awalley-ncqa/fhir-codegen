...
namespace fhir_R4
{
  ...
  /// </summary>
  struct ActivityDefinitionParticipant {
    /// <summary>
  ...
  /// </summary>
  struct ActivityDefinitionDynamicValue {
    /// <summary>
    /// Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
    /// </summary>
    string _id;
  ...
  struct ActivityDefinition {
    ...
    ActivityDefinitionParticipant** _participant;
    /// <summary>
    ...
    ActivityDefinitionDynamicValue** _dynamicValue;
  };
};
